<?php
  ...
  define('EMAIL_FROM_NAME', 'Havainas Ticket Center');

  define('EMAIL_FROM_ADDRESS', 'noreply@havaianas.com.br');

  define('EMAIL_DEFAULT_SUBJECT', 'Havaianas - Abertura de Chamado');
